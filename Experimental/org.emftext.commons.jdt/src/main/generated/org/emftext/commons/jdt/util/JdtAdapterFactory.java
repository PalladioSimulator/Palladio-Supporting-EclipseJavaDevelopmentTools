...
public class JdtAdapterFactory extends AdapterFactoryImpl
{
	...
	protected JdtSwitch<Adapter> modelSwitch =
		...
		{
			@Override
			public Adapter caseJDTJavaClassifier(JDTJavaClassifier object)
			{
				return createJDTJavaClassifierAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.commons.jdt.JDTJavaClassifier <em>JDT Java Classifier</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.emftext.commons.jdt.JDTField <em>JDT Field</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
