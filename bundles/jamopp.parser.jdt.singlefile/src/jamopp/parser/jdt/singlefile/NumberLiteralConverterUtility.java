...
class NumberLiteralConverterUtility {
	...
	static org.emftext.language.java.literals.Literal convertToLiteral(NumberLiteral literal) {
		...
		if (string.startsWith(BIN_PREFIX) && string.endsWith(LONG_SUFFIX)) {
			org.emftext.language.java.literals.BinaryLongLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createBinaryLongLiteral();
			...
			org.emftext.language.java.literals.BinaryIntegerLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createBinaryIntegerLiteral();
			...
			org.emftext.language.java.literals.HexFloatLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createHexFloatLiteral();
			...
			org.emftext.language.java.literals.HexDoubleLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createHexDoubleLiteral();
			lit.setHexValue(Double.parseDouble(string));
			result = lit;
		} else if (string.startsWith(HEX_PREFIX) && string.endsWith(LONG_SUFFIX)) {
			org.emftext.language.java.literals.HexLongLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createHexLongLiteral();
			...
			org.emftext.language.java.literals.HexIntegerLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createHexIntegerLiteral();
			lit.setHexValue(new BigInteger(string.substring(HEX_PREFIX.length()), HEX_BASE));
			result = lit;
		} else if (string.endsWith(FLOAT_SUFFIX)) {
			org.emftext.language.java.literals.DecimalFloatLiteral lit =
			...
			org.emftext.language.java.literals.DecimalDoubleLiteral lit =
			...
			org.emftext.language.java.literals.DecimalLongLiteral lit =
			...
			org.emftext.language.java.literals.DecimalIntegerLiteral lit = org.emftext.language
			...
			org.emftext.language.java.literals.OctalLongLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createOctalLongLiteral();
			lit.setOctalValue(new BigInteger(string.substring(OCT_PREFIX.length(),
					string.length() - LONG_SUFFIX.length()), OCT_BASE));
			result = lit;
		} else {
			org.emftext.language.java.literals.OctalIntegerLiteral lit =
					org.emftext.language.java.literals.LiteralsFactory.eINSTANCE.createOctalIntegerLiteral();
