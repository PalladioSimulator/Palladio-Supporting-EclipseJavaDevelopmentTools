...
public class AnnotationsTests extends TestSuite {
	...
	public static Test suite() {
		...
		suite.addTestSuite(AnnotationInstanceTest.class);
		suite.addTestSuite(SingleAnnotationParameterTest.class);
		suite.addTestSuite(AnnotationParameterListTest.class);
		suite.addTestSuite(AnnotationAttributeSettingTest.class);
		return suite;
	}
