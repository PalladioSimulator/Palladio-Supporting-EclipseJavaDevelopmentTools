...
public class ParametersTests extends TestSuite {
	...
	public static Test suite() {
		...
		suite.addTestSuite(OrdinaryParameterTest.class);
		suite.addTestSuite(VariableLengthParameterTest.class);
		suite.addTestSuite(CatchParameterTest.class);
		suite.addTestSuite(ReceiverParameterTest.class);
		return suite;
	}
