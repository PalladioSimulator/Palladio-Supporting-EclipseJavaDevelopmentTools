...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>parameters</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				OrdinaryParameter root = ParametersFactory.eINSTANCE.createOrdinaryParameter();
