 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.jdt.metamodel.javamodel.variables.impl.AdditionalLocalVariableImpl#getArrayDimensionsBefore <em>Array Dimensions Before</em>}</li>
 *   <li>{@link org.palladiosimulator.jdt.metamodel.javamodel.variables.impl.AdditionalLocalVariableImpl#getArrayDimensionsAfter <em>Array Dimensions After</em>}</li>
 *   <li>{@link org.palladiosimulator.jdt.metamodel.javamodel.variables.impl.AdditionalLocalVariableImpl#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdditionalLocalVariableImpl extends ReferenceableElementImpl implements AdditionalLocalVariable {
    ...
    public EList<ArrayDimension> getArrayDimensionsBefore() {
        if (arrayDimensionsBefore == null) {
            arrayDimensionsBefore = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this,
                    VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__ARRAY_DIMENSIONS_BEFORE);
        }
    ...
    public EList<ArrayDimension> getArrayDimensionsAfter() {
        if (arrayDimensionsAfter == null) {
            arrayDimensionsAfter = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this,
                    VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__ARRAY_DIMENSIONS_AFTER);
        }
    ...
    public NotificationChain basicSetInitialValue(Expression newInitialValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__INITIAL_VALUE, oldInitialValue, newInitialValue);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInitialValue != initialValue) {
            ...
            if (initialValue != null)
                msgs = ((InternalEObject) initialValue).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__INITIAL_VALUE, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__INITIAL_VALUE, newInitialValue, newInitialValue));
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ArrayTypeable.class) {
            ...
            case ArraysPackage.ARRAY_TYPEABLE__ARRAY_DIMENSIONS_BEFORE:
                return VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__ARRAY_DIMENSIONS_BEFORE;
            case ArraysPackage.ARRAY_TYPEABLE__ARRAY_DIMENSIONS_AFTER:
                return VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__ARRAY_DIMENSIONS_AFTER;
            default:
                return -1;
            }
        }
        if (baseClass == Initializable.class) {
            ...
            case InstantiationsPackage.INITIALIZABLE__INITIAL_VALUE:
                return VariablesPackage.ADDITIONAL_LOCAL_VARIABLE__INITIAL_VALUE;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
        if (baseClass == ArrayTypeable.class) {
            ...
            case ArraysPackage.ARRAY_TYPEABLE___GET_ARRAY_DIMENSION:
                return VariablesPackage.ADDITIONAL_LOCAL_VARIABLE___GET_ARRAY_DIMENSION;
            default:
                return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
        case VariablesPackage.ADDITIONAL_LOCAL_VARIABLE___GET_ARRAY_DIMENSION:
