 ...
 * @generated
 */
public class ModulesActionBarContributor
	 ...
	 * @generated
	 */
	public ModulesActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("modules-settings"));
		toolBarManager.add(new Separator("modules-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(JavaEditorPlugin.INSTANCE.getString("_UI_ModulesEditor_menu"), "org.emftext.language.java.modulesMenuID");
