...
import org.apache.bcel_6_5_0.verifier.statics.Pass1Verifier;
import org.apache.bcel_6_5_0.verifier.statics.Pass2Verifier;
import org.apache.bcel_6_5_0.verifier.statics.Pass3aVerifier;
import org.apache.bcel_6_5_0.verifier.structurals.Pass3bVerifier;
...
public class Verifier {
        ...
        for (final Pass3aVerifier pv : p3avs.values()) {
            ...
            for (final String element : p3am) {
                messages.add("Pass 3a, method " + meth + " ('"
                        + org.apache.bcel_6_5_0.Repository.lookupClass(classname).getMethods()[meth]
                        + "'): " + element);
            }
        }
    ...
    public static void main( final String[] args ) {
        ...
        for (int index = 0; index < args.length; index++) {
            try {
                ...
                org.apache.bcel_6_5_0.Repository.clearCache();
                System.gc();
    ...
    static void verifyType(final String fullyQualifiedClassName) throws ClassNotFoundException {
        ...
        if (verificationResult == VerificationResult.VR_OK) {
            final JavaClass jc = org.apache.bcel_6_5_0.Repository.lookupClass(fullyQualifiedClassName);
