...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.jdt.metamodel.javamodel.expressions.ShiftExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShiftExpressionItemProvider extends RelationExpressionChildItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ExpressionsPackage.Literals.SHIFT_EXPRESSION__CHILDREN);
            childrenFeatures.add(ExpressionsPackage.Literals.SHIFT_EXPRESSION__SHIFT_OPERATORS);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_ShiftExpression_type");
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.SHIFT_EXPRESSION__CHILDREN,
        ...
        newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.SHIFT_EXPRESSION__SHIFT_OPERATORS,
                OperatorsFactory.eINSTANCE.createLeftShift()));

        newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.SHIFT_EXPRESSION__SHIFT_OPERATORS,
                OperatorsFactory.eINSTANCE.createRightShift()));

        newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.SHIFT_EXPRESSION__SHIFT_OPERATORS,
                OperatorsFactory.eINSTANCE.createUnsignedRightShift()));
    }
