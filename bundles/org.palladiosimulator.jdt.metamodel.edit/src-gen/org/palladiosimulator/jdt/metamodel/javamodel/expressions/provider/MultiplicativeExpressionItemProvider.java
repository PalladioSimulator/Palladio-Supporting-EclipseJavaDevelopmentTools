...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.jdt.metamodel.javamodel.expressions.MultiplicativeExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiplicativeExpressionItemProvider extends AdditiveExpressionChildItemProvider {
    /**
     ...
     * @generated
     */
    public MultiplicativeExpressionItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ExpressionsPackage.Literals.MULTIPLICATIVE_EXPRESSION__CHILDREN);
            childrenFeatures.add(ExpressionsPackage.Literals.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_OPERATORS);
        }
    ...
    /**
     * This returns MultiplicativeExpression.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiplicativeExpression"));
    }
    ...
    public String getText(Object object) {
        return getString("_UI_MultiplicativeExpression_type");
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(MultiplicativeExpression.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.MULTIPLICATIVE_EXPRESSION__CHILDREN,
        ...
        newChildDescriptors.add(
                createChildParameter(ExpressionsPackage.Literals.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_OPERATORS,
                        OperatorsFactory.eINSTANCE.createDivision()));

        newChildDescriptors.add(
                createChildParameter(ExpressionsPackage.Literals.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_OPERATORS,
                        OperatorsFactory.eINSTANCE.createMultiplication()));

        newChildDescriptors.add(
                createChildParameter(ExpressionsPackage.Literals.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_OPERATORS,
                        OperatorsFactory.eINSTANCE.createRemainder()));
    }
