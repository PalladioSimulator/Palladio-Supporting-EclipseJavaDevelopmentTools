...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.jdt.metamodel.javamodel.references.ReferenceableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceableElementItemProvider extends NamedElementItemProvider {
    /**
    ...
    public String getText(Object object) {
        String label = ((ReferenceableElement) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ReferenceableElement_type")
                : getString("_UI_ReferenceableElement_type") + " " + label;
    }
