...
TOKENS {
    ...
    DEFINE FRAGMENT DIGITS $(('0'..'9')+|('0'..'9')('_'|'0'..'9')*('0'..'9'))$;
    DEFINE FRAGMENT HEX_DIGITS $(('0'..'9'|'a'..'f'|'A'..'F')+|('0'..'9'|'a'..'f'|'A'..'F')('_'|'0'..'9'|'a'..'f'|'A'..'F')*('0'..'9'|'a'..'f'|'A'..'F'))$;
    ...
    DEFINE DECIMAL_DOUBLE_LITERAL DIGITS + $'.'$ + DIGITS + $? (('e'|'E') ('+'|'-')? $ + DIGITS + $ )? ('d'|'D')?$
        ...
        + $|$ + DIGITS + $('e'|'E') ('+'|'-')? $ + DIGITS + $ ('d'|'D')?$
        + $|$ + DIGITS + $ ('d'|'D')$;
    DEFINE DECIMAL_LONG_LITERAL $('0'|'1'..'9''0'..'9'*|'1'..'9'('_'|'0'..'9')*'0'..'9')('l'|'L')$;
    DEFINE DECIMAL_INTEGER_LITERAL $('0'|'1'..'9''0'..'9'*|'1'..'9'('_'|'0'..'9')*'0'..'9')$;

    DEFINE OCTAL_LONG_LITERAL $'0'(('0'..'7')+|('0'..'7')('_'|'0'..'7')*('0'..'7'))('l'|'L')$;
    DEFINE OCTAL_INTEGER_LITERAL $'0'(('0'..'7')+|('0'..'7')('_'|'0'..'7')*('0'..'7'))$;

    DEFINE BINARY_LONG_LITERAL $'0'('b'|'B')(('0'|'1')+|('0'|'1')('_'|'0'|'1')*('0'|'1'))('l'|'L')$;
    DEFINE BINARY_INTEGER_LITERAL $'0'('b'|'B')(('0'|'1')+|('0'|'1')('_'|'0'|'1')*('0'|'1'))$;
